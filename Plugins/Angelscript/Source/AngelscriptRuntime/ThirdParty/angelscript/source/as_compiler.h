...
struct asCExprContext
{
	...
	void SetAnonymousInitList(asCScriptNode *initList, asCScriptCode *script = 0);
...
//[UE++]: Export compiler internals for the AngelscriptTest module.
class ANGELSCRIPTRUNTIME_API asCCompiler
//[UE--]
{
public:
