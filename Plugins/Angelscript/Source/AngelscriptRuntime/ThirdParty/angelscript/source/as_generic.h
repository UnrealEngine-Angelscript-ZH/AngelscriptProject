...
class ANGELSCRIPTRUNTIME_API asCGeneric final : public asIScriptGeneric
//[UE--]
{
public:
//------------------------------
...
//------------------------------
	...
	asIScriptFunction *GetFunction() const { return (asIScriptFunction*)sysFunction; }
	void              *GetAuxiliary() const;

	// Object
	void   *GetObject() { return currentObject; }
