...
class ANGELSCRIPTRUNTIME_API asCModule : public asIScriptModule
//[UE--]
{
//-------------------------------------------
// Public interface
...
public:
	...
	//[UE++]: Expose stock 2.38 global lookup APIs on the APV2 module surface.
...
//protected:
	...
	//[UE++]: Preserve imported function traits when porting the stock 2.38 import surface.
	...
	//[UE++]: Reintroduce the bounded stock restore helper surface while keeping APV2 storage containers.
	void               AddClassType(asCObjectType* type);
	void               AddEnumType(asCEnumType* type);
	void               AddTypeDef(asCTypedefType* type);
	void               AddFuncDef(asCFuncdefType* type);
