...
AS_FORCE_LINK const FAngelscriptBinds::FBind Bind_FGuid(FAngelscriptBinds::EOrder::Late, []
{
...

	{
		...
		FAngelscriptBinds::BindGlobalFunction("bool Parse(const FString& GuidString, FGuid& OutGuid)", FUNCPR_TRIVIAL(bool, FGuid::Parse, (const FString&, FGuid&)));

		FAngelscriptBinds::BindGlobalFunction("bool ParseExact(const FString& GuidString, EGuidFormats Format, FGuid& OutGuid)", FUNCPR_TRIVIAL(bool, FGuid::ParseExact, (const FString&, EGuidFormats, FGuid&)));
	}
});
