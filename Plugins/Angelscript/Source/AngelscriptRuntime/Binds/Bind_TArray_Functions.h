...
#include "Binds/Bind_TArray_Structs.h"
...
ANGELSCRIPTRUNTIME_API struct FArrayOperations* ValidateArrayOperations(class asITypeInfo* TemplateType, class asCString* ErrorMessage);
