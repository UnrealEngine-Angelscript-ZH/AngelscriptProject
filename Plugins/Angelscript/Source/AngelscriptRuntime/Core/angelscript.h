...
enum asEEngineProp
{
	...
	//[UE++]: Move APV2 custom engine properties above the stock 2.38 range to avoid property ID collisions.
	asEP_AUTOMATIC_IMPORTS                  = 41,
	asEP_TYPECHECK_SWITCH_ENUMS             = 42,
	asEP_ALLOW_DOUBLE_TYPE             = 43,
	asEP_FLOAT_IS_FLOAT64             = 44,
	asEP_WARN_ON_FLOAT_CONSTANTS_FOR_DOUBLES  = 45,
	asEP_WARN_INTEGER_DIVISION  = 46,
	//[UE--]
...
// Object type flags
	//[UE++]: Widen object flags and restore the stock 2.38 bit layout while preserving APV2 private flags in a high-bit range.
#ifdef _MSC_VER
	#define AS_OBJFLAG_UINT64 unsigned __int64
	#define AS_OBJFLAG_ONE ((AS_OBJFLAG_UINT64)1)
#else
	#define AS_OBJFLAG_UINT64 uint64_t
	#define AS_OBJFLAG_ONE ((AS_OBJFLAG_UINT64)1)
#endif

enum asEObjTypeFlags : AS_OBJFLAG_UINT64
{
	asOBJ_REF                        = (AS_OBJFLAG_ONE<<0),
	asOBJ_VALUE                      = (AS_OBJFLAG_ONE<<1),
	asOBJ_GC                         = (AS_OBJFLAG_ONE<<2),
	asOBJ_POD                        = (AS_OBJFLAG_ONE<<3),
	asOBJ_NOHANDLE                   = (AS_OBJFLAG_ONE<<4),
	asOBJ_SCOPED                     = (AS_OBJFLAG_ONE<<5),
	asOBJ_TEMPLATE                   = (AS_OBJFLAG_ONE<<6),
	asOBJ_ASHANDLE                   = (AS_OBJFLAG_ONE<<7),
	asOBJ_APP_CLASS                  = (AS_OBJFLAG_ONE<<8),
	asOBJ_APP_CLASS_CONSTRUCTOR      = (AS_OBJFLAG_ONE<<9),
	asOBJ_APP_CLASS_DESTRUCTOR       = (AS_OBJFLAG_ONE<<10),
	asOBJ_APP_CLASS_ASSIGNMENT       = (AS_OBJFLAG_ONE<<11),
	asOBJ_APP_CLASS_COPY_CONSTRUCTOR = (AS_OBJFLAG_ONE<<12),
	...
	asOBJ_APP_PRIMITIVE              = (AS_OBJFLAG_ONE<<13),
	asOBJ_APP_FLOAT                  = (AS_OBJFLAG_ONE<<14),
	asOBJ_APP_ARRAY                  = (AS_OBJFLAG_ONE<<15),
	asOBJ_APP_CLASS_ALLINTS          = (AS_OBJFLAG_ONE<<16),
	asOBJ_APP_CLASS_ALLFLOATS        = (AS_OBJFLAG_ONE<<17),
	asOBJ_NOCOUNT                    = (AS_OBJFLAG_ONE<<18),
	asOBJ_APP_CLASS_ALIGN8           = (AS_OBJFLAG_ONE<<19),
	asOBJ_IMPLICIT_HANDLE            = (AS_OBJFLAG_ONE<<20),
	asOBJ_APP_ALIGN16                = (AS_OBJFLAG_ONE<<30),
	asOBJ_APP_CLASS_MORE_CONSTRUCTORS = (AS_OBJFLAG_ONE<<31),
	asOBJ_APP_CLASS_UNION            = (AS_OBJFLAG_ONE<<32),
	// Internal flags
	asOBJ_SCRIPT_OBJECT              = (AS_OBJFLAG_ONE<<21),
	asOBJ_SHARED                     = (AS_OBJFLAG_ONE<<22),
	asOBJ_NOINHERIT                  = (AS_OBJFLAG_ONE<<23),
	asOBJ_FUNCDEF                    = (AS_OBJFLAG_ONE<<24),
	asOBJ_LIST_PATTERN               = (AS_OBJFLAG_ONE<<25),
	asOBJ_ENUM                       = (AS_OBJFLAG_ONE<<26),
	asOBJ_TEMPLATE_SUBTYPE           = (AS_OBJFLAG_ONE<<27),
	asOBJ_TYPEDEF                    = (AS_OBJFLAG_ONE<<28),
	asOBJ_ABSTRACT                   = (AS_OBJFLAG_ONE<<29),
	asOBJ_TEMPLATE_SUBTYPE_COVARIANT = (AS_OBJFLAG_ONE<<48),
	asOBJ_TEMPLATE_SUBTYPE_DETERMINES_SIZE = (AS_OBJFLAG_ONE<<49),
	asOBJ_DISALLOW_INSTANTIATION     = (AS_OBJFLAG_ONE<<50),
	asOBJ_BASICMATHTYPE              = (AS_OBJFLAG_ONE<<51),
	asOBJ_EDITOR_ONLY                = (AS_OBJFLAG_ONE<<52),
	asOBJ_MASK_VALID_FLAGS           = (asOBJ_REF | asOBJ_VALUE | asOBJ_GC | asOBJ_POD | asOBJ_NOHANDLE | asOBJ_SCOPED | asOBJ_TEMPLATE | asOBJ_ASHANDLE | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR | asOBJ_APP_CLASS_DESTRUCTOR | asOBJ_APP_CLASS_ASSIGNMENT | asOBJ_APP_CLASS_COPY_CONSTRUCTOR | asOBJ_APP_PRIMITIVE | asOBJ_APP_FLOAT | asOBJ_APP_ARRAY | asOBJ_APP_CLASS_ALLINTS | asOBJ_APP_CLASS_ALLFLOATS | asOBJ_NOCOUNT | asOBJ_APP_CLASS_ALIGN8 | asOBJ_IMPLICIT_HANDLE | asOBJ_APP_ALIGN16 | asOBJ_APP_CLASS_MORE_CONSTRUCTORS | asOBJ_APP_CLASS_UNION | asOBJ_TEMPLATE_SUBTYPE_COVARIANT | asOBJ_TEMPLATE_SUBTYPE_DETERMINES_SIZE | asOBJ_DISALLOW_INSTANTIATION | asOBJ_BASICMATHTYPE | asOBJ_EDITOR_ONLY)
};
	//[UE--]

#undef AS_OBJFLAG_UINT64
#undef AS_OBJFLAG_ONE
...
public:
	...
	// Object types
	//[UE++]: Widen RegisterObjectType flags for stock 2.38 compatibility and APV2 private high-bit flags.
...
public:
	...
	//[UE++]: Widen type flag queries for stock 2.38 compatibility and APV2 private high-bit flags.
